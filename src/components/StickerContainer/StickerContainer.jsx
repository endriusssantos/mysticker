...
const StickerContainer = ({ stickerData, stickerRef }) => {
  return (
    <section className="flex flex-col items-center">
      ...
      >
        ...
        <div
          className={
            stickerData.photo
              ? "absolute top-[7%] left-1/2 z-10 h-[70%] w-[50%] -translate-x-1/2 overflow-hidden"
        ...
        <span className="absolute right-[15%] bottom-[11%] left-[0%] z-10 text-2xl font-bold uppercase md:text-[29px]">
